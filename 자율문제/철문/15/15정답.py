...
# # count_lost = 0
# # count_draw = 0
# count_win,count_lost,count_draw = 0,0,0
# while True:
# #승리회수가 2번이상 또는 패배 회수가 2번 이상이면 ,프로그램 종료
#     if count_win>=2 or count_lost >=2:
#         # print("승리: is me")
#         # if count_win >=2:
#         #     print("is me")
#         # else:
#         #     print("파소콘")   
#         # break
#         print("승리:","사용자"if count_win >=2 else"파소콘")
#         print("전적:",f"{count_win}승{count_lost}패{count_draw}mu")
#         break
# #사용자로 부터 입력 받기
#     input_user = input("가위,바위,보 중 입력:")
#     if input_user =="가위" or input_user =="바위" or input_user=="보":
#         break
#     print("가위,바위,보 중에서 하나만 입력")
# #컴퓨터 랜덤선택
# #random -> 정수(integer)
#     rsp=["가위","바위","보"]
